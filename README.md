...
- Built a double-hashing lookup system with tombstone deletion and periodic rehashing (CLEAN), achieving O(1) average-case country retrieval over a 512-slot table